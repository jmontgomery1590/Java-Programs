...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (userPassword == 8) {
            eightDigit = true;
            if (Character.isUpperCase(inputPassword.charAt(0)) || Character.isUpperCase(inputPassword.charAt(1)) ||
                ...
                hasUppercase = true;
                if (Character.isDigit(inputPassword.charAt(0)) || Character.isDigit(inputPassword.charAt(1)) ||
        ...
        if (eightDigit && hasUppercase && hasDigit) {
